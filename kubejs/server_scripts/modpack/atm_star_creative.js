...
ServerEvents.recipes((allthemods) => {
  // Functional Storage
  allthemods.shaped(Item.of("functionalstorage:max_storage_upgrade", 8), ["NNN", "NsN", "NNN"], {
  ...
  allthemods.recipes.kubejs
    .shaped('ironjetpacks:cell[ironjetpacks:jetpack_id="ironjetpacks:creative",rarity="epic"]', [" A ", "BCB", " A "], {
