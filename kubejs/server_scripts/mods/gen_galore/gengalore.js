ServerEvents.recipes((allthemods) => {
  ...
  allthemods.shaped("generatorgalore:netherstar_generator", ["AAA", "ABA", "ACA"], {
  ...
  // culinary generator
  allthemods.shaped("generatorgalore:culinary_generator", ["AAA", "ABA", "ACA"], {
    A: "#c:crops",
  ...
  // ender generator
  allthemods.shaped("generatorgalore:ender_generator", ["AAA", "ABA", "ACA"], {
  ...
  // iron generator
  allthemods.shaped("generatorgalore:iron_generator", ["AAA", "ABA", "ACA"], {
  ...
  // magmatic generator
  allthemods.shaped("generatorgalore:magmatic_generator", ["AAA", "DBD", "ACA"], {
  ...
  allthemods.shaped("generatorgalore:enchantment_generator", ["AAA", "ABA", "DCD"], {
  ...
  // enchantment generator
  allthemods.shaped("generatorgalore:netherite_generator", ["AAA", "ABA", "DCD"], {
  ...
  allthemods.replaceInput(
    { output: /generatorgalore:.*_generator_8x/ },
    "minecraft:echo_shard",
    "alltheores:diamond_gear"
  )

  allthemods.replaceInput(
    { output: /generatorgalore:.*_generator_64x/ },
    "minecraft:conduit",
