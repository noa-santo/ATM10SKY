ServerEvents.recipes((allthemods) => {
  ...
  allthemods.shaped("cobblegengalore:block_gen_stone", ["AAA", "WBL", "AAA"], {
  ...
  allthemods.shaped("cobblegengalore:block_gen_copper", ["AAA", "WBL", "AAA"], {
  ...
  allthemods.shaped("cobblegengalore:block_gen_iron", ["AAA", "WBL", "AAA"], {
  ...
  allthemods.shaped("cobblegengalore:block_gen_gold", ["AAA", "WBL", "AAA"], {
  ...
  allthemods.shaped("cobblegengalore:block_gen_emerald", ["AAA", "WBL", "AAA"], {
    A: "minecraft:emerald",
    W: "#c:buckets/water",
    L: "#c:buckets/lava",
  ...
  allthemods.shaped("cobblegengalore:block_gen_diamond", ["AAA", "WBL", "AAA"], {
    A: "minecraft:diamond",
    W: "#c:buckets/water",
    L: "#c:buckets/lava",
  ...
  allthemods.shaped("cobblegengalore:block_gen_netherite", ["AAA", "WBL", "AAA"], {
