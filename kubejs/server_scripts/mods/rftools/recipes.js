...
ServerEvents.recipes((allthemods) => {
  ...
  // Fix Syringe Display
  allthemods.shaped(Item.of("rftoolsutility:flight_module", 1), ["DUD", "DND", "DPD"], {
